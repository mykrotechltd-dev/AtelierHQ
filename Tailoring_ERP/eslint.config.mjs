...
export default defineConfig([
  ...
  {
    // Context providers co-export their consumer hook (AuthProvider +
    // useSession, MeasurementUnitProvider + useMeasurementUnit) by design.
    files: ["src/components/providers/**"],
    rules: {
      "react-refresh/only-export-components": "off",
    },
  },
