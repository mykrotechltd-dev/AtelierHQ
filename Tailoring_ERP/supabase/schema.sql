...
begin
  ...
  -- Rollout gate (0011): a tenant with no notify_sender_name set hasn't
  -- been opted into live notifications yet — silent, not an error, since
  -- most tenants simply aren't enabled during a staged rollout.
